# Generated by Django 3.2.19 on 2023-07-01 12:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, help_text='Введите имя пользователя', max_length=150, unique=True, validators=[apps.users.validators.validate_username], verbose_name='Ник-нейм')),
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(('user', django.db.models.expressions.F('author')), _negated=True), name='different_users'),
        ),
    ]
